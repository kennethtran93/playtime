	...
	<div id="body">
		<div class="content">
			<div>
				<div>
					<h1>Shakes</h1>
					<div> <a href="/menu/shake"><img src="/images/shake.jpg" width="434" height="347" alt=""></a> </div>
					<ul>
						<li>
							<h2><a href="/menu/shake">Chocolate Vanilla</a></h2>
							<p>
						...
						<li>
							<h2><a href="/menu/shake">Strawberry Smoothie</a></h2>
							<p>
								This website template has been designed by Free Website Templates for you, for free. You can replace all this text with your own text.
							</p>
						...
						<li>
							<h2><a href="/menu/shake">Mango Banana Medley</a></h2>
							<p>
								This website template has been designed by Free Website Templates for you, for free. You can replace all this text with your own text.
							</p>
						...
						<li class="last	">
							<h2><a href="/menu/shake">Dark Chocolate Supreme</a></h2>
							<p>
		...
		<div class="sidebar">
			...
			<ul class="navigation">
				...
				<li>
					<a class="active" href="/menu/shake">SHAKES</a>
				</li>
				<li>
					<a href="/menu/breakfast">BREAKFAST</a>
				</li>
			</ul>
			<a href="/menu/shake" class="download">&nbsp;</a> </div>
	</div>
	<div id="footer">
		<div>
			<ul>
