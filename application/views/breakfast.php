	...
	<div id="body">
		<div class="content">
			<div>
				<div>
					<h1>Breakfast</h1>
					<div> <a href="/menu/breakfast"><img src="/images/breakfast2.jpg" width="484" height="271" alt=""></a> </div>
					<ul>
						<li>
							<h2><a href="/menu/breakfast">Strawberry Waffle</a></h2>
							<p>
						...
						<li>
							<h2><a href="/menu/breakfast">Bacon and Eggs</a></h2>
							<p>
								This website template has been designed by Free Website Templates for you, for free. You can replace all this text with your own text.
							</p>
						...
						<li>
							<h2><a href="/menu/breakfast">French Toast With Eggs</a></h2>
							<p>
								This website template has been designed by Free Website Templates for you, for free. You can replace all this text with your own text.
							</p>
						...
						<li class="last	">
							<h2><a href="/menu/breakfast">Bacon and Pancakes</a></h2>
							<p>
		...
		<div class="sidebar">
			...
			<ul class="navigation">
				...
				<li>
					<a href="/menu/hotdog">HOTDOGS</a>
				</li>
				<li>
					<a href="/menu/shake">SHAKES</a>
				</li>
				<li>
					<a class="active" href="/menu/breakfast">BREAKFAST</a>
				</li>
			</ul>
			<a href="/menu/breakfast" class="download">&nbsp;</a> </div>
	</div>
	<div id="footer">
		<div>
			<ul>
